...
| `76a2b80f` | Require the deorbit phase corridor; stop unsafe correction behaviour. | **Passed offline tests and build; live result pending.** | Not yet tested. | This version has not yet received a KSP landing result. It is the currently installed DLL. |
